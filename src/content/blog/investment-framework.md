...
### Preface
While the notion of an "Automated Investing Machine" capable of predicting market movements and generating extraordinary gains seems like something market strategists should strive for, the reality is that such a constantly self-calibrating system that anticipates market movements is virtuall impossible

The need for overly complex mathematical models that are fed noisy, unnormalized garbage data, that claims to have forecasting value, is unreplicable by the layman and it also totally defies Occam's razor principle of favoring simplicity. At the get go, to obtain data with forecasting value in the short-term often comes with significant operating costs, which erodes the net returns. Within this blogpost, i'll share with you an investment framework that stood the test of, replicable by the retail investor, that could generate outsize returns in 1-3 years.
...
2. Because of 1. they would have to give up on excess volatility and uncertainty that comes with higher returns in exchange for steadier returns in the ball park of 5-12%. This is because their primary objective is to retain existing clients and attract new ones.(Having a -15% year and a subsequent 45% year, would likely lose you more AUM than if you had two years of steady 8% returns even though the former generates higher returns)
3. Because of 1. and 2., they would need to have strict risk limits inplace and hence can only hold small positions of stocks that have crashed in price despite having a huge turnaround opportunity.(Since most measures of risk/volatility is based on historical price movements).
...
The great hockey player Wayne Gretzky provides a great hockey analogy to investing : **"You would want to skate to where the puck is going to be, not where it has been"**, and that means basing a stock's future performance in the FUTURE not the PAST. What it has done in the past provides necessary hints on the capability (or inability) of management, the companies competitive advantage, but it's only one part of the picture. Besides, most of what you read and watch on financial news has already been priced in by some wall street firm receiving the information hours earlier than you. The alpha for retail really are in the details of forward-looking statements (e.g. Q&A) within earnings calls, overlooked by Wall Street responding to mere headline figures (either Revenue, EPS, Cash flow are within expectations or not)


__**The Templeton Curve**__

![The Templeton Curve](../../../public/euphoria.png)


The curve above illustrates when you should start building a position and accumulate shares as a retail with no restrictions. Institutional investors have strict mandates and run a career risk if they have huge drawdowns, hence why they feel more safe to get in on stocks that have reached beyond the Skepticism phase. ETFs and Mutual Funds often weigh a company based on their market cap which agrees that their ownership goes up beyond Skepticism. To achieve superior returns as retail, you need to be bold enough to buy the fear and be comfortable with drawdowns. You need to know that **the bulk of the gains tend to happen during the move from deep pessimism to the return of optimism, and it tends to happen very quickly as well**. The long-term investor can then slowly ride it to euphoria -- the stage when valuation multiples get re-rated and expand, which is also the stage where you begin trimming positions. Simply put, **Opinion follows Trend** and what you hear of a company tightly relates to a companies stock price. When price craters, so would market participants opinion toward a stock. Ultimately it is up to the diligent investor, to determine the divergence between price and true value of the company, and how much of the divergence is based on irraitonal fear and whether it is justfied.

Human nature and market structure allows the opportunistic long-term investor to scoop up shares of wonderful businesses/brands at a discounted price. Afterall, **Wall Street is the only place where everyone runs for the exit, when there is a fire sale**. So if you're an investor with no significant upcoming liabilities, an investor that can overtime build a position in investment ideas that are at peak pessimism but would eventually revitalize and show growth in 12-36 months from now, and hold them to euphoria, you will undoubtedly make outsize returns.
...
For instance, a portfolio consisting of 100 altcoins would not be considered diversified, nor would a portfolio of 50 biotech companies racing to develop a cancer cure, or betting on 10 different New Electric Vehicle companies. In such cases, the thesis of your investment is driven by a single underlying factor, for altcoins, it would be lack of government trust or speculative cryptocurrency trends; for biotech companies, it would be the success or failure of a specific drug trial; and for EV companies, it would be new energy vehicle policies and tarriffs on EV imports.

The key is to always diversify across industries/countries if possible. **You however can't diversify away systematic risks that drive the overall market** , such as interest rates that dictate the cost of borrowing, overall consumer confidence, economic growth etc. However these macro risks often get's reflected in the Beta of your portfolio, so a tactical Beta hedge with puts in overbought situations could do the job.
